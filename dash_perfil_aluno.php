...
<div class="w3-container">
    <div class="w3-row">
        <div class="w3-row">
            ...
            <div class="w3-col">
                <div class="w3-row"><strong>Nome:</strong> <?php echo htmlspecialchars($nome); ?></div><br>
                <div class="w3-row"><strong>Email:</strong> <?php echo htmlspecialchars($email); ?></div><br>
                <div class="w3-row"><strong>Data de Nascimento:</strong> <?php echo htmlspecialchars($data_nascimento); ?></div><br>
                <div class="w3-row"><strong>Cidade:</strong> <?php echo htmlspecialchars($cidade); ?></div><br>
                <div class="w3-row"><strong>Estado:</strong> <?php echo htmlspecialchars($estado); ?></div><br>
                <div class="w3-row"><strong>Biografia:</strong> <?php echo htmlspecialchars($biografia); ?></div><br>
            </div>
        </div>
        <div class="w3-row">
            <div class="w3-col">
        ...
        <div class="w3-row w3-center w3-centered">
            <div class="w3-col w3-center w3-centered">
